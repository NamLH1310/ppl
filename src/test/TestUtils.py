...
class TestCodeGen():
    ...
    def check(soldir,asttree,num):
        ...
        try:
            ...
            subprocess.call("java  -jar "+ JASMIN_JAR + " " + path + "/Program.j",shell=True,stderr=subprocess.STDOUT)
            
            subprocess.run("java -cp ./lib:. Program",shell=True, stdout = f, timeout=10)
        except StaticError as e:
            f.write(str(e))
